...
- [x] HTML 41 個 ID 均唯一、37 個 JavaScript ID 綁定皆有對應元素，兩個 dialog 結構與 CSS 括號檢查通過。
- [x] 本機 HTTP 200；回傳 v0.42、時間軸首頁與輸入 dialog，且不含入口頁、AI 分析或「開始整理」區塊。
...
- [ ] 含假姓名的手動測試資料，在新增、摘要與編輯中保持原始內容。待本次彈窗流程複核。

## 發布狀態

- 本機版本：`v0.42-manual-only-timeline`
