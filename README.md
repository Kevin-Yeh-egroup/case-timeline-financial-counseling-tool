...
- Version `v0.6` focuses the people layer on household members/cohabitants first, and lets events and decisions link to related household members.
...
- `app.js`: timeline, household-member, chart, decision-card, AI import draft queue, safety-check, and XLSX export logic
